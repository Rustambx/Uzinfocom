...
')
     ...
     */ 
        ...
        {
                        /** @var \App\Modules\Book\Services\BookService $instance */
                        return $instance->update($request, $book);
        }
                    /**
         * 
         *
     ...
     */ 
        ...
        {
                        /** @var \App\Modules\User\Services\UserService $instance */
                        return $instance->update($request, $user);
        }
                    /**
         * 
         *
     ...
     */ 
         ...
         * @static 
         */ 
        public static function cloneRoles($companyId)
        {
                        /** @var \App\Modules\RBAC\Services\RBACService $instance */
                        return $instance->cloneRoles($companyId);
        }
                    /**
         ...
         * @static 
         */ 
        public static function getCompanyRoles($company)
        {
                        /** @var \App\Modules\RBAC\Services\RBACService $instance */
                        return $instance->getCompanyRoles($company);
        }
                    /**
         ...
         *
         * @param \App\Modules\RBAC\Services\Role $role
         * @return \App\Modules\RBAC\Services\RoleResource 
         * @static 
         */ 
        public static function roleToResource($role)
        {
                        /** @var \App\Modules\RBAC\Services\RBACService $instance */
                        return $instance->roleToResource($role);
        }
                    /**
         * Returns all roles.
         *
...
namespace  { 
            ...
            class BookService extends \App\Modules\Book\Facades\BookFacade {}
