            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body card-block">
                        ...
                        <form action="{{ route('books.update', $book) }}" method="post" enctype="multipart/form-data" class="form-horizontal" novalidate>
                            @csrf
                            @method('PUT')
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">@lang('main.name')</label></div>
                                <div class="col-12 col-md-9">
                                    <input type="text" id="title" name="name" value="{{ $book->name }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="title" name="name_en" value="{{ $book->name_en }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="title" name="price" value="{{ $book->price }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <textarea name="description_en" id="" cols="70" rows="10">{{ $book->description_en }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <textarea name="text" id="" cols="100" rows="10">{{ $book->text }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <textarea name="text_en" id="" cols="100" rows="10">{{ $book->text_en }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="title" name="author" value="{{ $book->author }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="title" name="author_en" value="{{ $book->author_en }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="title" name="release_year" value="{{ $book->release_year }}" class="form-control">
                                </div>
                            </div>
